...
// a cycle is three or more nodes connect in a winding path
//graphs have neighbors, not hierarchial
//trees have children, are  hierarchial
...
const title = head.addChild('title - Melissa Tree')
const header = body.addChild('header')
const main = body.addChild('main')
const footer = body.addChild('footer')
const h1 = header.addChild('h1- Tree Lesson')
const p = main.addChild('p - look at my cool learning tree')
